...
<meta charset="UTF-8">
   ...
   <script type="text/javascript">
        var managerChangePwdUrl = '<?php echo U("Deal/managerChangePwd",'','');?>';
        var managerPwdSuccessUrl = '<?php echo U("managerPwdSuccess",'','');?>';
        var managerbackUrl = '<?php echo U("manageInfo",'','');?>';
    </script>

   <script src ="__PUBLIC__/js/manageChangePwd.js"></script>
                ...
                <form id="userChangePwdForm">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-4 col-xs-offset-4 ">
                            <button type ="button" class="btn btn-large btn-info" onclick="back()">返回</button>
                        </div>
                    </div>
                </div>
                <div class = "rightBtn">
