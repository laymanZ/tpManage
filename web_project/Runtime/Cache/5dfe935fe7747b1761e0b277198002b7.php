...
<div class="adMessage">
	<h1>欢迎</h1>
	<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;这里是青协会员的专属乐园，在这里你可以畅所欲言，也可以分享你的心情，抒发快乐与不快，
	也可以就青协的工作提出改进意见，我们乐于听取每个人的意见，青协是个大家庭，只有更好的交流才能更好的成长</h3>
	<h2>Now Let's go on</h2>
</div>
...
<!-- 右边分类 start-->
	<div class="rightAssort">
		<h2>专题区</h2>
		<hr/>
		<a href="__URL__/manageAngleAdvice">天使行动</a><br/>
		<a href="__URL__/manageLoveTeachAdvice">爱心家教</a><br/>
		<a href="__URL__/manageNationalVolunteerAdvice">国际志愿者日</a><br/>
		<br/><br/>
		<h2>调查问卷</h2>
		<hr/>
		<a href="#">活动征集</a><br/>
...
<!-- 多说JS代码 start -->
var duoshuoQuery = {short_name:"advice"};
	(function() {
