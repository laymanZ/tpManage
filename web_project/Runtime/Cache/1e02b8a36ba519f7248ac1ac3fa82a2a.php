    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="" onclick="clickIndex()">首页</a></li>
                <li class="active"><a href="javascript:void(0)">关于我们</a></li>
                <li><a href="" onclick="clickAdvice()">留言建议</a></li>
                <li><a href="" onclick="clickActivity()">发布活动</a></li>
            </ul>
        ...
        <ul class="nav navbar-nav">
                <li><a href="" onclick="manageCenter()">管理中心</a></li>
        </ul>
      </ul>
        </div>
    </div>
...
<script>
    ...
    function clickIndex()
    {
        window.location.href = "__URL__/manageIndexPage";
    }
    function clickAdvice()
    {
        window.location.href = "__URL__/manageAdvicePage";
    }
    function manageCenter()
    {
        window.location.href = "__URL__/managePage";
    }

    function clickActivity()
    {
        window.location.href = "__URL__/manageActivity";
    }
</script>
</body>
</html>